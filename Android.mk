...
# Creating prebuilt for dependency: monkecomputer - version: 1.4.0
include $(CLEAR_VARS)
...
LOCAL_LDLIBS += -llog
LOCAL_CFLAGS += -I'extern/libil2cpp/il2cpp/libil2cpp' -isystem 'extern' -I'extern/monkecodegen/include' -DID='"GOOMPS"' -DVERSION='"1.0.0"' -I'./shared' -I'./extern' -Wno-inaccessible-base -Wno-invalid-offsetof
